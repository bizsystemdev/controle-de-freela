...
export default function Index() {
  ...
  return (
    <div
      className={`flex-1 flex flex-col items-center justify-between p-8 bg-gradient-to-b from-white via-slate-50 to-red-50/30 transition-opacity duration-300 ${
    ...
    >
      ...
      <div className="flex flex-col items-center text-center -mt-8">
        <div className="relative mb-6">
          <div className="absolute -inset-4 bg-red-600/15 rounded-3xl blur-xl animate-pulse" />
          <AppLogo size="xl" className="relative shadow-2xl shadow-red-600/30" />
        </div>
      ...
      <div className="w-full flex flex-col items-center gap-3 pb-6">
        ...
        <span className="text-xs font-medium text-slate-400">Iniciando Biz Check...</span>
      </div>
    </div>
  )
}
