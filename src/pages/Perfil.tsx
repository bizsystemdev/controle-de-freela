    ...
    <div className="flex-1 flex flex-col justify-between p-6 sm:p-7 bg-slate-50/50">
      ...
      <div>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Perfil</h1>
        </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <div
                      className={`w-9 h-9 rounded-full bg-gradient-to-tr ${comp.gradient} flex items-center justify-center text-white text-xs font-bold shrink-0`}
                    >
                      {comp.initial}
                    </div>
                    <div className="min-w-0">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-semibold text-slate-800">Trocar empresa</span>
            </div>
          ...
          <button
            ...
            className="w-full p-4 flex items-center justify-between text-left hover:bg-rose-50/50 transition-colors active:bg-rose-50"
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-xl bg-rose-50 text-rose-600 flex items-center justify-center">
                <LogOut className="w-4 h-4" />
              </div>
              <span className="text-sm font-semibold text-rose-600">Sair da conta</span>
            </div>
      ...
      <div className="text-center pt-6 pb-2">
        <p className="text-xs text-slate-400 font-medium">Presença App • Versão 1.0.0</p>
      </div>
        ...
        <DialogContent className="max-w-xs rounded-3xl p-6 bg-white border border-slate-100">
          <DialogHeader className="text-center sm:text-center">
            ...
            <DialogDescription className="text-xs sm:text-sm text-slate-500 text-center pt-1">
              Sua sessão será encerrada e você precisará informar o telefone novamente.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter className="flex flex-col gap-2 sm:flex-col mt-4">
            <button
              ...
              className="w-full h-12 rounded-xl bg-rose-600 hover:bg-rose-700 active:scale-95 text-white font-bold text-sm shadow-md shadow-rose-600/20 transition-all flex items-center justify-center"
            >
              Sim, sair agora
            </button>
            <button
