  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in">
      <div className="w-full max-w-xs bg-white rounded-3xl p-6 shadow-2xl flex flex-col items-center text-center animate-fade-in-up border border-slate-100">
        ...
        <h2 className="text-2xl font-extrabold text-slate-900 mb-1">Check-out realizado!</h2>
        <p className="text-base font-semibold text-emerald-600 mb-1">Saída registrada às {time}</p>
        <p className="text-xs text-slate-600 font-medium mb-1">
          Tempo de permanência: <strong className="text-slate-900 font-bold">{duration}</strong>
        </p>
        <p className="text-[11px] text-slate-400 font-normal mb-6">{companyName}</p>
